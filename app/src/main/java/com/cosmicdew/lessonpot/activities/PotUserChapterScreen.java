...
import com.cosmicdew.lessonpot.adapters.PagerAdapterForPotChapter;
...
public class PotUserChapterScreen extends PotBaseActivity {
    ...
    private Chapters m_cChaptersGen;
    private PagerAdapterForPotChapter m_cPagerAdapter;
    ...
    protected void onCreate(Bundle pSavedInstance) {
        ...
        if (m_cToolBar != null){
            ...
            String lsub = String.format("%s %s (%s)",
                    ...
                    m_cUser.getLastName(),
                    m_cUser.getRole());
            m_cHeaderTitle.setText(m_cSyllabi.getName());
    ...
    private void init() {
        m_cTabLayout.addTab(m_cTabLayout.newTab().setText("Chapters"));
...
//        m_cTabLayout.setTabMode(TabLayout.MODE_SCROLLABLE);
        ...
        m_cPagerAdapter = new PagerAdapterForPotChapter(getSupportFragmentManager(),
                m_cObjFragmentBase,
...
//                        m_cObjTransportMgr.getPackages("", EURemediesSpecialityScreen.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_add:
                ...
                lObjIntent.putExtra(PotMacros.OBJ_CHAPTERS, (new Gson()).toJson(getChaptersGen()));
        ...
        switch (pObjMessage.what) {
            case R.id.action_notify:
                if (pObjMessage.arg1 == 0){
                    lObjIntent = new Intent(PotUserChapterScreen.this, PotUserHomeScreen.class);
                    ...
                    lObjIntent = new Intent(PotUserChapterScreen.this, PotUserNetworkScreen.class);
                    lObjIntent.putExtra(PotMacros.OBJ_USER, (new Gson()).toJson((Users) pObjMessage.obj));
                    lObjIntent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                    lObjIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    startActivity(lObjIntent);
    ...
    public Chapters getChaptersGen() {
        return m_cChaptersGen;
    }

    public void setChaptersGen(Chapters pChaptersGen) {
        this.m_cChaptersGen = pChaptersGen;
    }
}
