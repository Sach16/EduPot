...
public class MultiPartRequest<T> extends Request<T> {
    ...
    public MultiPartRequest(int method, String url, String methodName, Class<T> clazz, HashMap<String, String> feedParams, ServerCallback<T> sourceListener, Object refObj,  RequestManager.IQListener<T> successListener, Response.ErrorListener listener, String fileKey, File file) {
