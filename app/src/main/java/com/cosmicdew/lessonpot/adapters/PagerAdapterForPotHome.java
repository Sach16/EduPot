...
public class PagerAdapterForPotHome extends FragmentStatePagerAdapter{
    ...
    public Fragment getItem(int position) {
        switch (position) {
            case 0:
                m_cObjFragmentBase = PotUserHomeClassesFragment.newInstance(position, m_cId, m_cUser, null, null);
                return m_cObjFragmentBase;
            case 1:
                m_cObjFragmentBase = PotUserHomeClassesViewedFragment.newInstance(position, m_cId, m_cUser);
                return m_cObjFragmentBase;
            case 2:
                m_cObjFragmentBase = PotUserHomeClassesReceivedFragment.newInstance(position, m_cId, m_cUser);
                return m_cObjFragmentBase;
            case 3:
                m_cObjFragmentBase = PotUserHomeClassesMineFragment.newInstance(position, m_cId, m_cUser);
                return m_cObjFragmentBase;
            default:
                return null;
        }
