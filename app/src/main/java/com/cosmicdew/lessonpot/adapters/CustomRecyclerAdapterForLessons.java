...
public class CustomRecyclerAdapterForLessons extends RecyclerView.Adapter{
    ...
    public CustomRecyclerAdapterForLessons(Context pContext, Users pUsers, BoardChoices pBoardChoices,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            ...
            CustomRecyclerAdapterForLessons.DataObjectHolder ldataObjectHolder = new CustomRecyclerAdapterForLessons.DataObjectHolder(lView);
            vh = ldataObjectHolder;
        } else {
            lView = LayoutInflater.from(parent.getContext()).inflate(R.layout.progressdialog_paging, parent, false);
            CustomRecyclerAdapterForLessons.ProgressViewHolder lprogressViewHolder = new CustomRecyclerAdapterForLessons.ProgressViewHolder(lView);
        ...
        if (holder instanceof CustomRecyclerAdapterForLessons.DataObjectHolder) {
            ...
            try {
                if (PotMacros.getIsTodaysDate(m_cObjLessons.get(position).getModified(), PotMacros.DATE_FORMAT_UNDERSC_YYYYMMDD_HHMMSS_SSSSSS))
                    ((CustomRecyclerAdapterForLessons.DataObjectHolder) holder).modifiedTime
            ...
            try {
                ((CustomRecyclerAdapterForLessons.DataObjectHolder) holder).lessonNameTxt
            ...
            try {
                ((CustomRecyclerAdapterForLessons.DataObjectHolder) holder).authorNameTxt
            ...
            try {
                ((CustomRecyclerAdapterForLessons.DataObjectHolder) holder).subChapterTxt
            ...
            try {
                ((CustomRecyclerAdapterForLessons.DataObjectHolder) holder).classBoardTxt
            ...
            ((CustomRecyclerAdapterForLessons.ProgressViewHolder) holder).progressBar.setIndeterminate(true);
        }
    }
