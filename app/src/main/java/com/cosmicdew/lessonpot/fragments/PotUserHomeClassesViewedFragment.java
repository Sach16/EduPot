...
public class PotUserHomeClassesViewedFragment extends PotFragmentBaseClass implements RecyclerHomeListener {
    ...
    public PotUserHomeClassesViewedFragment() {
        super();
    }

    public static PotUserHomeClassesViewedFragment newInstance(int pPosition, String pKey, Users pUser, String pGoOffline) {
        PotUserHomeClassesViewedFragment lPotUserHomeClassesViewedFragment = new PotUserHomeClassesViewedFragment();
        ...
        lPotUserHomeClassesViewedFragment.setArguments(args);

        return lPotUserHomeClassesViewedFragment;
    }
...
//                            doPagination(lpage);
        ...
        placeUserRequest(Constants.VIEWED + Constants.LESSONS, LessonViewsAll.class, null, null, null, false);
            ...
            case PotMacros.ON_INFO_LONG_CLICK_VIEWED:
                switch (pObjMessage.arg1) {
                    ...
                    case R.id.action_save:
                        ((PotUserHomeScreen) m_cObjMainActivity).checkAndDownloadAttachments(((LessonViews) pObjMessage.obj).getLesson(), ((LessonViews) pObjMessage.obj).getSource().getId());
                        break;
                }
                break;
            default:
...
//                                ((PotUserLessonScreen) m_cObjMainActivity).setLessonsGen(lLessons);
                        ...
                        if (null != m_cLessonsList && m_cLessonsList.size() > 0) {
                            m_cRecycClassesAdapt = new CustomRecyclerAdapterForLessonsViewed(m_cObjMainActivity, m_cUser, null,
