...
public class PotUserHomeClassesMineFragment extends PotFragmentBaseClass implements RecyclerHomeListener, OnStartDragListener {
    ...
    public PotUserHomeClassesMineFragment() {
        super();
    }

    public static PotUserHomeClassesMineFragment newInstance(int pPosition, String pKey, Users pUser, String pGoOffline) {
        PotUserHomeClassesMineFragment lPotUserHomeClassesMineFragment = new PotUserHomeClassesMineFragment();
        ...
        lPotUserHomeClassesMineFragment.setArguments(args);

        return lPotUserHomeClassesMineFragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        m_cObjMainActivity.m_cObjFragmentBase = PotUserHomeClassesMineFragment.this;
...
//                            doPagination(lpage);
    ...
    private void initOffline() {
        ...
        List<LessonsTable> lessonsTableList = LessonsTable.find(LessonsTable.class, "user_id = ? and owner_id = ? and lesson_id != -1",String.valueOf(m_cUser.getId()), String.valueOf(m_cUser.getId()));
            ...
            case PotMacros.ON_INFO_LONG_CLICK_MINE:
                switch (pObjMessage.arg1) {
                    ...
                    case R.id.action_save:
                        ((PotUserHomeScreen) m_cObjMainActivity).checkAndDownloadAttachments((Lessons) pObjMessage.obj, ((Lessons) pObjMessage.obj).getOwner().getId(),
