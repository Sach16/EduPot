...
//                            doPagination(lpage);
    ...
    private void initOffline() {
        ...
        List<LessonsTable> lessonsTableList = LessonsTable.find(LessonsTable.class, "user_id = ? and owner_id = ?",String.valueOf(m_cUser.getId()), String.valueOf(m_cUser.getId()));
