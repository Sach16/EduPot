...
//                            doPagination(lpage);
    ...
    private void initOffline() {
        ...
        List<LessonsTable> lessonsTableList = LessonsTable.find(LessonsTable.class, "sharer_id != ? and sharer_id != -1 and user_id = ?", String.valueOf(m_cUser.getId()), String.valueOf(m_cUser.getId()));
